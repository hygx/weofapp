 ...
 */
package com.example.weofapphao.czm.common.io;

import android.os.Build;

import com.example.weofapphao.czm.common.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.example.weofapphao.czm.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.example.weofapphao.czm.common.io.stream.ByteArrayOutputStream output = new  com.example.weofapphao.czm.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
