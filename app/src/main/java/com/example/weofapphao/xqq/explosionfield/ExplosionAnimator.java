...
public class ExplosionAnimator extends ValueAnimator {
    public final static long DEFAULT_DURATION;
    private final static Interpolator DEFAULT_INTERPOLATOR;
    private final static float END_VALUE;
    private final static float X;
    private final static float Y;
    private final static float V;
    private final static float W;
